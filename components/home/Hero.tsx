export function Hero() {
  return (
    <section className="relative flex min-h-[92vh] items-end overflow-hidden border-b border-line">
      <div className="absolute inset-0 z-0 bg-[linear-gradient(160deg,theme(colors.bg.2)_0%,theme(colors.bg.0)_70%)]" />
      <div className="absolute inset-0 z-[1] bg-[linear-gradient(180deg,rgba(11,12,14,.55)_0%,rgba(11,12,14,.75)_55%,#0b0c0e_100%)]" />
